...
@section('content')
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Currency</a> <a href="#" class="current">Add Currency</a> </div>
            <h1>Add Currency</h1>
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="{{route('add-currency')}}" name="add_category" id="add_currency" novalidate="novalidate">
                                @csrf
